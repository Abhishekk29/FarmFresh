                        ...
                        <div class="login">
                            <div class="login-bottom">
                                ...
                                <form action="AddCustomer" method="post">
                                    ...
                                    <div class="sign-up">
                                        <h4>Email :</h4>
                                        <input title="must have @gmail.com." type="text" placeholder="@gmail.com" pattern=".+@gmail\.com"  required="" style="width: 680px;" name="email">
                                    </div>
                                    <div class="sign-up">
                                        <h4>Password :</h4>
                                    ...
                                    <div class="sign-up">
                                        <h4>Phone :</h4>
                                        <input type="text" pattern="[0-9]{10}" title='must have 10 numbers from 0-9' placeholder="Type here" required="" style="width: 680px;" name="mobile">
                                    </div>
                                    <div class="sign-up">
                                        <h4>Gender :</h4>
                                    ...
                                    <div class="sign-up">
                                        <h4>Pin Code :</h4>
                                        <input type="text" pattern="[0-9]{6}" title='must have 6 numbers from 0-9' placeholder="Pincode" required="" style="width: 680px;" name="pincode">
                                    </div>
                                    <div class="sign-up">
